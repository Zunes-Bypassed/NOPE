...
wait(0.1)  -- Đợi một thời gian trước khi ẩn

-- Ẩn thông báo NOPE với animation
tweenTextLabel(1, 1, UDim2.new(0.25, 0, 0.3, -50))  -- Di chuyển lên và ẩn "NOPE"

wait(0.1)  -- Đợi để "NOPE" hoàn toàn biến mất

-- Hiển thị thông báo "Tạo Bởi #codertoolroblox" với animation
textLabel.Text = "Tạo Bởi #codertoolroblox"
textLabel.TextColor3 = Color3.fromRGB(255, 255, 0)
textLabel.Position = UDim2.new(0.25, 0, 0.3, 0)  -- Đặt lại vị trí
tweenTextLabel(1, 0, textLabel.Position)  -- Hiển thị "Tạo Bởi #codertoolroblox"

wait(0.1)  -- Đợi một thời gian trước khi ẩn

-- Ẩn thông báo "Tạo Bởi #codertoolroblox" với animation
tweenTextLabel(1, 1, UDim2.new(0.25, 0, 0.3, -50))  -- Di chuyển lên và ẩn "Tạo Bởi #codertoolroblox"
...
local Window = redzlib:MakeWindow({ Title = "NOPE", SubTitle = "Redz Library", SaveFolder = "NOPE.json" })
Window:AddMinimizeButton({
  Button = { Image = "rbxassetid://85503651118321", BackgroundTransparency = 0 },
  Corner = { CornerRadius = UDim.new(0, 6) }
})

local Tabs = {
  Items = Window:MakeTab({"Items"}),
  Stats = Window:MakeTab({"Stats"}),
  MainFarm = Window:MakeTab({"Farm"}),
...
local _MainFarm = Tabs.MainFarm do
  _MainFarm:AddDropdown({"Farm Type", Loaded.WeaponsList, Settings.ToolFarm, function(Value)
    Settings.ToolFarm = Value
  end, "Main/FarmTool"})
  _MainFarm:AddSection("Farm")
  AddToggle(_MainFarm, {"Auto Farm Level", ("Max Level: %i"):format(MSetting.Setting.MaxLevel)}, "Level Farm")
  ...
  AddToggle(_MainFarm, {"Auto Farm Raid", "Level: 1000"}, "Raid Farm")
end
